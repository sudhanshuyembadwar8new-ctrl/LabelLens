  ...
  return (
    <LabelLensAuthBackground>
        ...
        >
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-[9px] font-mono font-bold bg-amber-900/80 text-amber-300 border border-amber-700/60 px-1.5 py-0.2 rounded">
                SUPERVISORY
              </span>
            </div>
            <p className="text-[10px] text-slate-400 font-medium">
              Legal Metrology Administrative Console
            </p>
          </div>
        </div>
      ...
      <footer className="border-t border-slate-900 bg-slate-950/80 py-3 px-4 text-center text-xs text-slate-500">
        <p>National Legal Metrology Administrative Gateway &bull; Directorate of Legal Metrology &bull; Government of India</p>
      </footer>
    </LabelLensAuthBackground>
  );
};
